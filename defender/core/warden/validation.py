...
CONDITIONS_VALIDATORS = {
    ...
    Condition.DisplayNameMatchesAny: NonEmptyListStr,
    Condition.DisplayNameMatchesRegex: IsRegex,
...
CONDITIONS_USER_CONTEXT = [
    ...
    Condition.DisplayNameMatchesAny,
    Condition.DisplayNameMatchesRegex,
